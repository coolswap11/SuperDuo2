...
public class DatabaseContract
{
    ...
    public static final class scores_table implements BaseColumns
    {
        ...
        public static final String HOME_LOGO_URL = "home_logo_url";
        public static final String AWAY_LOGO_URL = "away_logo_url";
    ...
    public static final String ACTION_DATA_UPDATED = CONTENT_AUTHORITY + ".ACTION_DATA_UPDATED";
}
